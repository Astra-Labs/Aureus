...
class HeadingTwoText extends Text {
  HeadingTwoText(String data) : super(data);
}

class HeadingThreeText extends Text {
  HeadingThreeText(String data) : super(data);

}

class HeadingFourText extends Text {
  HeadingFourText(String data) : super(data);

}

class BodyOneText extends Text {
  BodyOneText(String data) : super(data);

}

class BodyTwoText extends Text {
  BodyTwoText(String data) : super(data);

}

class SubheaderText extends Text {
  SubheaderText(String data) : super(data);
