...
class _SearchBarComponentState extends State<SearchBarComponent> {
  ...
  Widget build(BuildContext context) {
    return AspectRatio(
        aspectRatio: 585 / 73,
        child: Container(width: 585, height: 73, child: Row(children: [
          Container(
            width: 250,
            height: 60,
            ...
            child: Center(
              ...
              child: TextFormField(
                  ...
                  keyboardType: dataTextType),
            )), 
          Container(
        alignment: Alignment.centerRight,
        padding: EdgeInsets.all(5),
        decoration: BoxDecoration(shape: BoxShape.circle, gradient: foundation.mediumGradient()),
        width: 73.0,
        height: 73.0,
        child: Expanded(
            child: IconButton(
